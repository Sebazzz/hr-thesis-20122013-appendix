...
namespace Prototype.FubuApp
{
    ...
    public static class ViewHelpers
    {
        ...
        public static MvcHtmlString ColumnHeader<TViewModel, TEntity, TProperty>(
                this FubuMVC.Razor.Rendering.FubuRazorView<TViewModel> view,
                Expression<Func<TEntity, TProperty>> columnToDisplay) where TViewModel : class
        {
            return ColumnHeader(view, columnToDisplay, null);
        }

        public static MvcHtmlString ColumnHeader<TViewModel, TEntity, TProperty>(
                    this FubuMVC.Razor.Rendering.FubuRazorView<TViewModel> view,
                    Expression<Func<TEntity, TProperty>> columnToDisplay,
                    string customDisplayName) where TViewModel : class
        {
            // get property name
            PropertyInfo columnToDisplayPropInfo = columnToDisplay.GetPropertyInfo();
            string propertyName = columnToDisplay.GetPropertyPath();
        ...
        /// </summary>
        public static string DescriptionFor<TViewModel, TEntity, TProperty>(this FubuMVC.Razor.Rendering.FubuRazorView<TViewModel> htmlHelper, Expression<Func<TEntity, TProperty>> propertyToDisplay) where TViewModel : class
        {
        ...
        /// </summary>
        public static string NameFor<TViewModel, TEntity, TProperty>(this FubuMVC.Razor.Rendering.FubuRazorView<TViewModel> htmlHelper, Expression<Func<TEntity, TProperty>> propertyToDisplay) where TViewModel : class
        {
            PropertyInfo selectedProperty = propertyToDisplay.GetPropertyInfo();
        ...
        /// Returns the value of the <see cref="DisplayAttribute"/> <see cref="DisplayAttribute.Name"/> for the specified <paramref name="propertyToDisplay"/>
        /// </summary>
        public static string Name<TEntity>(this FubuMVC.Razor.Rendering.FubuRazorView htmlHelper, Expression<Func<TEntity, object>> propertyToDisplay)
        {
            PropertyInfo selectedProperty = propertyToDisplay.GetPropertyInfo();
