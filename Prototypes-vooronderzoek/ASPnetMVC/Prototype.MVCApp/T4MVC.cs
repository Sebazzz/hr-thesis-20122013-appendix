...
{
    public static Prototype.MVCApp.Controllers.HomeController Home = new Prototype.MVCApp.Controllers.T4MVC_HomeController();
    public static Prototype.MVCApp.Controllers.PersonController Person = new Prototype.MVCApp.Controllers.T4MVC_PersonController();
    public static Prototype.MVCApp.Controllers.ReportController Report = new Prototype.MVCApp.Controllers.T4MVC_ReportController();
